package com.djamware.demo.config;
...
import com.djamware.demo.services.CustomUserDetailsService; 
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers("/").hasAuthority("ADMIN").antMatchers("/h2/console").permitAll()
                ...
                .csrf().disable().formLogin().successHandler((CustomizeAuthenticationSuccessHandler) customizeAuthenticationSuccessHandler).loginPage("/login")
